...
export const ProjectsInfo = () => {
    ...
    return (
        <div className='w-full font-righteous mb-6'>
            <h2 className='font-extrabold text-6xl py-4'>Deployed Projects</h2>
            <div className='flex justify-between gap-4 w-full flex-wrap px-2'>
                {renderInfo()}
            </div>
        </div>
    )
...
const RenderProject = ({ item }) => {
    ...
    return (
        <div className='w-1/4'>
            ...
            <img src={`https://source.unsplash.com/random/1920x1080/?office,corporate?sig=${name}`} alt={name} />
